			...
			return {
				...
				project: [
					...
					...state.project,
					{
						...
						press_contacts: action.payload.connected_press_contacts,
						user_contacts: action.payload.connected_user_contacts,
						projectId: action.payload.projectId,
						projectCreateDate: action.payload.projectCreateDate,
						moodBoardName: action.payload.moodBoardName,
						moodboardID: action.payload.moodboardID,
